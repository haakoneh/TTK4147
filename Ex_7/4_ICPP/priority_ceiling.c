...
int set_task_priority(unsigned int priority){
...
void low_p_function(void *arg){
    ...
    set_task_priority(HIGHEST_PRIORITY);
    ...
    print_pri(NULL,"low_p function is done\n");
}
...
void high_p_function(void *arg){
    ...
    print_pri(NULL,"high_p function is done\n");
}
